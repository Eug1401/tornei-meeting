...
check('Cache busting aggiornato',/v17(?:0-favorite-match-refresh|1-favorite-team-list|2-match-detail-score|3-centered-score-fit)/.test(index),'Versione asset non aggiornata');

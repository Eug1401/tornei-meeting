(function(){
  ...
  async function createRecapDoc(s){
    ...
    doc.addPage();header('Classifica marcatori','Top 15 calciatori del torneo.');
  ...
  function renderTeamsList(container){
    ...
    box.innerHTML=`<div class="section-toolbar danger-toolbar"><div><strong>Staff squadre</strong><small>Pulisce presidente e allenatore senza toccare roster, calendario o risultati.</small></div><button class="btn danger" type="button" data-clear-all-staff> Pulisci presidenti e allenatori</button></div><div class="team-disclosure-list admin-disclosure-list">${s.teams.map((t,i)=>`<details class="ng-disclosure admin-team-disclosure">
